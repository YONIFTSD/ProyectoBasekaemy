              ...
              <form action="{{ route('client-update') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <select disabled name="document_type" class="form-control" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input disabled type="text" name="document_number" class="form-control" value="{{ $client->document_number}}" required>
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            <input disabled type="text" name="name" class="form-control" value="{{ $client->name}}" required>
                ...
                <div class="form-group row">
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input disabled type="text" name="phone" value="{{ $client->phone}}" class="form-control" >
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input disabled type="date" name="birth_date" class="form-control" value="{{ $client->birth_date}}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-5">
                        <label>Ubigeo</label>
                        <select disabled name="ubigee" class="form-control">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="input-group">
                            <input disabled type="text" name="address" value="{{ $client->address}}" class="form-control">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <label>Email *</label>
                        <div class="input-group">
                            <input disabled type="email" name="email" readonly class="form-control" value="{{ $client->email}}" required>
                ...
                <div class="form-group">
                    ...
                    <a href="{{ route('clients') }}" class="btn btn-primary">REGRESAR</a>
                </div>
              </form>
            </div>
        </div>
